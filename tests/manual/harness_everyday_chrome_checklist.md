...
5. desk-host running with `browser.driver: harness` (set in `config/desk.yaml` or `DESK_BROWSER_DRIVER=harness` — extension default is `extension`).
